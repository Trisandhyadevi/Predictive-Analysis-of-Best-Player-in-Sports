...
country <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\country.csv")
country
league <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\league.csv")
league
Match_1 <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\Match_1.csv")
Match_1
player <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\player.csv")
player
player_attributes <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\player_attributes.csv")
player_attributes
team <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\country.csv")
team
Team_attributes <- read.csv("C:\\Users\\devit\\Downloads\\Project_G10_2\\Team_attributes_1.csv")
Team_attributes
...
#ggplot(Team_attributes, aes(x = 1, y = buildUpPlaySpeed)) +
 # geom_boxplot() +
  #labs(title = "buildupplayspeed Boxplot", x = "", y = "playspeed") +
  #theme_minimal()
#Q1_s <- quantile(Team_attributes$buildUpPlaySpeed, 0.25)
#Q3_s <- quantile(Team_attributes$buildUpPlaySpeed, 0.75)
#IQR <- Q3_s - Q1_s

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_s - 1.5 * IQR
#upper_bound <- Q3_s + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(buildUpPlaySpeed >= lower_bound & buildUpPlaySpeed <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = buildUpPlayDribbling)) +
 # geom_boxplot() +
  #labs(title = "buildUpPlayDribbling Boxplot", x = "", y = "playspeed") +
  #theme_minimal()
#Q1_d <- quantile(Team_attributes$buildUpPlayDribbling, 0.25)
#Q3_d <- quantile(Team_attributes$buildUpPlayDribbling, 0.75)
#IQR <- Q3_d - Q1_d

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_d - 1.5 * IQR
#upper_bound <- Q3_d + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(buildUpPlayDribbling >= lower_bound & buildUpPlayDribbling <= upper_bound)
#################
#ggplot(Team_attributes, aes(x = 1, y = buildUpPlayPassing)) +
 # geom_boxplot() +
  #labs(title = "buildUpPlayPassing Boxplot", x = "", y = "playspeed") +
  #theme_minimal()
#Q1_p <- quantile(Team_attributes$buildUpPlayPassing, 0.25)
#Q3_p <- quantile(Team_attributes$buildUpPlayPassing, 0.75)
#IQR <- Q3_p - Q1_p

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_p - 1.5 * IQR
#upper_bound <- Q3_p + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(buildUpPlayPassing >= lower_bound & buildUpPlayPassing <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = chanceCreationPassing)) +
 # geom_boxplot() +
  #labs(title = "chanceCreationPassing Boxplot", x = "", y = "chanceCreationPassing") +
  #theme_minimal()
#Q1_cp <- quantile(Team_attributes$chanceCreationPassing, 0.25)
#Q3_cp <- quantile(Team_attributes$chanceCreationPassing, 0.75)
#IQR <- Q3_cp - Q1_cp

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_cp - 1.5 * IQR
#upper_bound <- Q3_cp + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(chanceCreationPassing >= lower_bound & chanceCreationPassing <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = chanceCreationCrossing)) +
 # geom_boxplot() +
  #labs(title = "chanceCreationCrossing Boxplot", x = "", y = "chanceCreationCrossing") +
  #theme_minimal()
#Q1_cc <- quantile(Team_attributes$chanceCreationCrossing, 0.25)
#Q3_cc <- quantile(Team_attributes$chanceCreationCrossing, 0.75)
#IQR <- Q3_cc - Q1_cc

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_cc - 1.5 * IQR
#upper_bound <- Q3_cc + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(chanceCreationCrossing >= lower_bound & chanceCreationCrossing <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = chanceCreationShooting)) +
 # geom_boxplot() +
  #labs(title = "chanceCreationShooting Boxplot", x = "", y = "chanceCreationShooting") +
  #theme_minimal()
#Q1_csh <- quantile(Team_attributes$chanceCreationShooting, 0.25)
#Q3_csh <- quantile(Team_attributes$chanceCreationShooting, 0.75)
#IQR <- Q3_csh - Q1_csh

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_csh - 1.5 * IQR
#upper_bound <- Q3_csh + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(chanceCreationShooting >= lower_bound & chanceCreationShooting <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = defencePressure)) +
 # geom_boxplot() +
  #labs(title = "defencePressure Boxplot", x = "", y = "defencePressure") +
  #theme_minimal()
#Q1_cdp <- quantile(Team_attributes$defencePressure, 0.25)
#Q3_cdp <- quantile(Team_attributes$defencePressure, 0.75)
#IQR <- Q3_cdp - Q1_cdp

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_cdp - 1.5 * IQR
#upper_bound <- Q3_cdp + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(defencePressure >= lower_bound & defencePressure <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = defenceAggression)) +
 # geom_boxplot() +
  #labs(title = "defenceAggression Boxplot", x = "", y = "defenceAggression") +
  #theme_minimal()
#Q1_cda <- quantile(Team_attributes$defenceAggression, 0.25)
#Q3_cda <- quantile(Team_attributes$defenceAggression, 0.75)
#IQR <- Q3_cda - Q1_cda

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_cda - 1.5 * IQR
#upper_bound <- Q3_cda + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(defenceAggression >= lower_bound & defenceAggression <= upper_bound)
#ggplot(Team_attributes, aes(x = 1, y = defenceTeamWidth)) +
 # geom_boxplot() +
  #labs(title = "defenceTeamWidth Boxplot", x = "", y = "defenceTeamWidth") +
  #theme_minimal()
#Q1_cdt <- quantile(Team_attributes$defenceTeamWidth, 0.25)
#Q3_cdt <- quantile(Team_attributes$defenceTeamWidth, 0.75)
#IQR <- Q3_cdt - Q1_cdt

# Define the upper and lower bounds for outliers
#lower_bound <- Q1_cdt - 1.5 * IQR
#upper_bound <- Q3_cdt + 1.5 * IQR

# Remove outliers
#Team_attributes <- Team_attributes %>%
 # filter(defenceTeamWidth >= lower_bound & defenceTeamWidth <= upper_bound)